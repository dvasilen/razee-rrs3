...
import (
	...
	externalversions "razee.dev/razee/pkg/client/informers/externalversions"
	client "razee.dev/razee/pkg/client/injection/client"
)
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch razee.dev/razee/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
